...
quietly infix                ///
  ...
  byte    uhrswork  96-97    ///
  byte    union     98-98    ///
  double  ftotval   99-108   ///
  double  inctot    109-116  ///
  long    incwage   117-123  ///
  long    incbus    124-130  ///
  long    incfarm   131-137  ///
  long    incss     138-142  ///
  long    incwelfr  143-147  ///
  long    incgov    148-152  ///
  long    incidr    153-157  ///
  long    incaloth  158-162  ///
  long    incretir  163-168  ///
  long    incssi    169-173  ///
  long    incdrt    174-178  ///
  long    incint    179-183  ///
  long    incunemp  184-188  ///
  long    incwkcom  189-193  ///
  long    incvet    194-198  ///
  long    incsurv   199-204  ///
  long    incdisab  205-210  ///
  long    incdivid  211-216  ///
  long    incrent   217-221  ///
  long    inceduc   222-226  ///
  long    incchild  227-231  ///
  long    incalim   232-236  ///
  long    incasist  237-241  ///
  long    incother  242-246  ///
  long    incdisa1  247-251  ///
  long    incdisa2  252-256  ///
  long    inclongj  257-263  ///
  long    increti1  264-268  ///
  long    increti2  269-273  ///
  long    incsurv1  274-278  ///
  long    incsurv2  279-283  ///
  long    oincbus   284-289  ///
  long    oincfarm  290-295  ///
  long    oincwage  296-302  ///
  byte    srcearn   303-303  ///
  long    adjginc   304-310  ///
  int     eitcred   311-314  ///
  long    fedtax    315-320  ///
  long    fedtaxac  321-326  ///
  byte    filestat  327-327  ///
  byte    margtax   328-329  ///
  long    statetax  330-335  ///
  long    stataxac  336-341  ///
  long    taxinc    342-348  ///
  byte    hcovany   349-349  ///
  byte    hinsemp   350-350  ///
  byte    hinspur   351-351  ///
  byte    hcovpub   352-352  ///
  byte    hinscaid  353-353  ///
  byte    hinscare  354-354  ///
  byte    hinsmil   355-355  ///
  using `"cps_00049.dat"'

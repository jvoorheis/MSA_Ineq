...
quietly infix                ///
  ...
  byte    uhrswork  85-86    ///
  byte    union     87-87    ///
  double  ftotval   88-97    ///
  double  inctot    98-105   ///
  long    incwage   106-112  ///
  long    incbus    113-119  ///
  long    incfarm   120-126  ///
  long    incss     127-131  ///
  long    incwelfr  132-136  ///
  long    incgov    137-141  ///
  long    incidr    142-146  ///
  long    incaloth  147-151  ///
  long    incretir  152-157  ///
  long    incssi    158-162  ///
  long    incdrt    163-167  ///
  long    incint    168-172  ///
  long    incunemp  173-177  ///
  long    incwkcom  178-182  ///
  long    incvet    183-187  ///
  long    incsurv   188-193  ///
  long    incdisab  194-199  ///
  long    incdivid  200-205  ///
  long    incrent   206-210  ///
  long    inceduc   211-215  ///
  long    incchild  216-220  ///
  long    incalim   221-225  ///
  long    incasist  226-230  ///
  long    incother  231-235  ///
  long    incdisa1  236-240  ///
  long    incdisa2  241-245  ///
  long    inclongj  246-252  ///
  long    increti1  253-257  ///
  long    increti2  258-262  ///
  long    incsurv1  263-267  ///
  long    incsurv2  268-272  ///
  long    oincbus   273-278  ///
  long    oincfarm  279-284  ///
  long    oincwage  285-291  ///
  byte    srcearn   292-292  ///
  int     eitcred   293-296  ///
  long    fedtax    297-302  ///
  long    fedtaxac  303-308  ///
  byte    filestat  309-309  ///
  byte    margtax   310-311  ///
  long    statetax  312-317  ///
  long    stataxac  318-323  ///
  byte    hcovany   324-324  ///
  byte    hinsemp   325-325  ///
  byte    hinspur   326-326  ///
  byte    hcovpub   327-327  ///
  byte    hinscaid  328-328  ///
  byte    hinscare  329-329  ///
  byte    hinsmil   330-330  ///
  using `"cps_00047.dat"'

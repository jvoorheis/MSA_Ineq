...
quietly infix                ///
  ...
  int     hispan    99-101   ///
  int     educ      102-104  ///
  byte    schlcoll  105-105  ///
  int     occ       106-109  ///
  int     ind       110-113  ///
  byte    classwkr  114-115  ///
  byte    wkswork1  116-117  ///
  byte    hrswork   118-119  ///
  byte    uhrswork  120-121  ///
  byte    union     122-122  ///
  double  ftotval   123-132  ///
  double  inctot    133-140  ///
  long    incwage   141-147  ///
  long    incbus    148-154  ///
  long    incfarm   155-161  ///
  long    incss     162-166  ///
  long    incwelfr  167-171  ///
  long    incgov    172-176  ///
  long    incidr    177-181  ///
  long    incaloth  182-186  ///
  long    incretir  187-192  ///
  long    incssi    193-197  ///
  long    incdrt    198-202  ///
  long    incint    203-207  ///
  long    incunemp  208-212  ///
  long    incwkcom  213-217  ///
  long    incvet    218-222  ///
  long    incsurv   223-228  ///
  long    incdisab  229-234  ///
  long    incdivid  235-240  ///
  long    incrent   241-245  ///
  long    inceduc   246-250  ///
  long    incchild  251-255  ///
  long    incalim   256-260  ///
  long    incasist  261-265  ///
  long    incother  266-270  ///
  long    incdisa1  271-275  ///
  long    incdisa2  276-280  ///
  long    inclongj  281-287  ///
  long    increti1  288-292  ///
  long    increti2  293-297  ///
  long    incsurv1  298-302  ///
  long    incsurv2  303-307  ///
  long    oincbus   308-313  ///
  long    oincfarm  314-319  ///
  long    oincwage  320-326  ///
  byte    srcearn   327-327  ///
  long    adjginc   328-334  ///
  int     eitcred   335-338  ///
  long    fedtax    339-344  ///
  long    fedtaxac  345-350  ///
  long    fica      351-355  ///
  byte    filestat  356-356  ///
  byte    margtax   357-358  ///
  long    statetax  359-364  ///
  long    stataxac  365-370  ///
  long    taxinc    371-377  ///
  byte    hcovany   378-378  ///
  byte    hinsemp   379-379  ///
  byte    hinspur   380-380  ///
  byte    hcovpub   381-381  ///
  byte    hinscaid  382-382  ///
  byte    hinscare  383-383  ///
  byte    hinsmil   384-384  ///
  using `"cps_00050.dat"'

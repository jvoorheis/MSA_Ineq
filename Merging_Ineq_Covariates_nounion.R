...
save(Ineq.work4, file="/media/john/Shared Linux_Windows Files/MSA Level Inequality/Data/MSA_covariates_nounion.rda")
write.dta(Ineq.work4, file="/media/john/Shared Linux_Windows Files/MSA Level Inequality/Data/MSA_covariates_nounion.dta")

save(Ineq.work5, file="/media/john/Shared Linux_Windows Files/MSA Level Inequality/Data/MSA_covariates_cellmean_nounion.rda")
write.dta(Ineq.work5, file="/media/john/Shared Linux_Windows Files/MSA Level Inequality/Data/MSA_covariates_cellmean_nounion.dta")
...
quietly infix                ///
  ...
  int     hispan    109-111  ///
  int     educ      112-114  ///
  byte    schlcoll  115-115  ///
  int     occ       116-119  ///
  int     ind       120-123  ///
  byte    classwkr  124-125  ///
  byte    wkswork1  126-127  ///
  byte    hrswork   128-129  ///
  byte    uhrswork  130-131  ///
  byte    union     132-132  ///
  double  ftotval   133-142  ///
  double  inctot    143-150  ///
  long    incwage   151-157  ///
  long    incbus    158-164  ///
  long    incfarm   165-171  ///
  long    incss     172-176  ///
  long    incwelfr  177-181  ///
  long    incgov    182-186  ///
  long    incidr    187-191  ///
  long    incaloth  192-196  ///
  long    incretir  197-202  ///
  long    incssi    203-207  ///
  long    incdrt    208-212  ///
  long    incint    213-217  ///
  long    incunemp  218-222  ///
  long    incwkcom  223-227  ///
  long    incvet    228-232  ///
  long    incsurv   233-238  ///
  long    incdisab  239-244  ///
  long    incdivid  245-250  ///
  long    incrent   251-255  ///
  long    inceduc   256-260  ///
  long    incchild  261-265  ///
  long    incalim   266-270  ///
  long    incasist  271-275  ///
  long    incother  276-280  ///
  long    incdisa1  281-285  ///
  long    incdisa2  286-290  ///
  long    inclongj  291-297  ///
  long    increti1  298-302  ///
  long    increti2  303-307  ///
  long    incsurv1  308-312  ///
  long    incsurv2  313-317  ///
  long    oincbus   318-323  ///
  long    oincfarm  324-329  ///
  long    oincwage  330-336  ///
  byte    srcearn   337-337  ///
  int     stimulus  338-341  ///
  long    adjginc   342-348  ///
  int     eitcred   349-352  ///
  long    fedtax    353-358  ///
  long    fedtaxac  359-364  ///
  long    fica      365-369  ///
  byte    filestat  370-370  ///
  byte    margtax   371-372  ///
  long    statetax  373-378  ///
  long    stataxac  379-384  ///
  long    taxinc    385-391  ///
  byte    hcovany   392-392  ///
  byte    hinsemp   393-393  ///
  byte    hinspur   394-394  ///
  byte    hcovpub   395-395  ///
  byte    hinscaid  396-396  ///
  byte    hinscare  397-397  ///
  byte    hinsmil   398-398  ///
  int     emcontrb  399-402  ///
  byte    gotwic    403-403  ///
  using `"cps_00054.dat"'

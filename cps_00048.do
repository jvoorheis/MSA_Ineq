...
quietly infix                ///
  ...
  int     eitcred   304-307  ///
  long    fedtax    308-313  ///
  long    fedtaxac  314-319  ///
  byte    filestat  320-320  ///
  byte    margtax   321-322  ///
  long    statetax  323-328  ///
  long    stataxac  329-334  ///
  byte    hcovany   335-335  ///
  byte    hinsemp   336-336  ///
  byte    hinspur   337-337  ///
  byte    hcovpub   338-338  ///
  byte    hinscaid  339-339  ///
  byte    hinscare  340-340  ///
  byte    hinsmil   341-341  ///
  using `"cps_00048.dat"'

...
library(foreign)
library(data.table)
MORG.work<-read.dta("morg_college.dta")
...
CBSA_FIPS_crosswalk_1<-read.csv("MORG_CBSA_FIPS.csv")
...
setkey(MORG_MSA_2004, state, year, MSA, MSA_FIPS_corrected, college)
setkey(MORG_MSA_2005, state, year, MSA, MSA_FIPS_corrected, college)
